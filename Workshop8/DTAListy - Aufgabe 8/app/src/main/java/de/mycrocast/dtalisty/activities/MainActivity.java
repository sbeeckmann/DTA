...
public class MainActivity extends AbstractActivity implements RecyclerClickListener, EntryHolderCreateDialog.OnEntryHolderCreated, EntryHolderEditDialog.OnEntryHolderEdit, EntryHolderManager.EntryHolderChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.entryRestCaller.getEntries(new Response.Listener<BasicResponse<List<EntryHolder>>>() {
            @Override
        ...
        new AlertDialog.Builder(MainActivity.this)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        MainActivity.this.entryRestCaller.deleteEntryHolder(entryHolder.getId(), new Response.Listener<BasicResponse<EntryHolder>>() {
                            @Override
    ...
    public void onEntryHolderCreated(String name) {
        this.entryRestCaller.createEntryHolder(name, new Response.Listener<BasicResponse<EntryHolder>>() {
            @Override
            public void onResponse(BasicResponse<EntryHolder> response) {
                if (response.getError() == null || response.getError().isEmpty()) {
    ...
    public void onEntryHolderEdit(EntryHolder entryHolder, final int index) {
        this.entryRestCaller.editEntryHolder(entryHolder.getId(), entryHolder.getName(), new Response.Listener<BasicResponse<EntryHolder>>() {
            @Override
            public void onResponse(BasicResponse<EntryHolder> response) {
                if (response.getError() == null || response.getError().isEmpty()) {
